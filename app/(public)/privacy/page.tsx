      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              When you connect third-party services to our Service, we may
              collect:
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
              ...
              <li>
                Google account information (when using Google authentication)
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
              ...
              <li>
                Usage data (pages visited, chart dashboard views, report
                generation activity)
              </li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
              <li>
                <strong>Third-Party Services:</strong> When you connect
                third-party services (QuickBooks, Notion), we share necessary
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              QuickBooks, Notion, and Google. These services have their own
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              contact us through the Service or using the contact information
