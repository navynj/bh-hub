        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              use the Service for your internal business purposes, including
              viewing chart dashboards and generating PDF P&amp;L reports.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              QuickBooks, Notion, and Google. Your use of these third-party
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              including if you breach this EULA.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              We reserve the right to modify this EULA at any time. We will
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              through the Service or via the contact information provided in our
              Privacy Policy.
            </p>
          </section>
        </div>
